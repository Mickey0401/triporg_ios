...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [UIFont fontWithName:@"HelveticaNeue" size:kLabelFontSize]; //[UIFont boldSystemFontOfSize:kLabelFontSize];
        self.labelColor = [UIColor whiteColor];
		self.detailsLabelFont = [UIFont fontWithName:@"HelveticaNeue" size:kDetailsLabelFontSize];    //[UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
