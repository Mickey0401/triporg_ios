...
- (void)setupView {
	...
	currentIdx = -1;
	star = [[UIImage imageNamed:@"star.png"] tintImageWithColor:[UIColor blackColor]];
	highlightedStar = [[UIImage imageNamed:@"star_highlighted.png"] tintImageWithColor:[UIColor blackColor]];
