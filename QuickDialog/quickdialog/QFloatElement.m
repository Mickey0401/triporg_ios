...
///Volumes/Work/Upwork/spain/QuickDialog/quickdialog/QElement.m
...
- (UITableViewCell *)getCellForTableView:(QuickDialogTableView *)tableView controller:(QuickDialogController *)controller {
    ...
    [cell.slider addTarget:self action:@selector(valueHasChange:) forControlEvents:UIControlEventTouchUpInside];
